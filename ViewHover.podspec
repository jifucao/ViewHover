...
Pod::Spec.new do |s|
  s.name             = 'ViewHover'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ViewHover.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Jifu/ViewHover'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Jifu' => 'caojifu@xunlei.com' }
  s.source           = { :git => 'https://github.com/Jifu/ViewHover.git', :tag => s.version.to_s }
